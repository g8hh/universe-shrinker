...
var cnItems = {
    ...
    "from it": "从它",
    "Gain more Theta Energy on Heat Death": "热死时获得更多 西塔能量",
    "Going small with Power": "用力量变小",
    "Heat Death everything and gain": "热死一切和获得",
    "in return.": "作为回报。",
    "Max": "最大",
    "Keep your highest Universe reached (don't go back to Universe": "保持你到达的最高宇宙（不回到宇宙",
    "Max all affects all tabs (except Heat Death) instead of the current selected": "最大全部 影响所有选项卡（热死除外）而不是当前选定的",
...
var cnPrefix = {
    ...
    "Lv.": "等级",
    "Heat Death (": "热死 (",
    "Heat Death resets all progress you made so far, but you will get ": "热死会重置你目前取得的所有进度，但你会得到",
    "Messed up? No worries, Respec to get all spent ": "搞砸了？ 不用担心，重洗 花掉所有的钱",
    "Theta Energy (": "西塔能量 (",
    "back, but you do a Heat Death without gaining ": "回来，但你在没有获得的情况下进行了热死",
    "": "",
    "": "",
    "": "",
    "": "",
