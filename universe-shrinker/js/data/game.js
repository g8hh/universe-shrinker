var game = {
    universes: [new Universe("Universe", new Decimal(8.37e26), new Decimal(1)),
        ...
        new Universe("Exaverse", new Decimal("9.51e184235"), new Decimal(1e15)),
        new Universe("Zettaverse", new Decimal("6.57e264862"), new Decimal(1e21)),
        new Universe("Yottaverse", new Decimal("4.52e410420"), new Decimal(1e28)),
        new Universe("Omniverse", new Decimal("1e1000000"), new Decimal(1e40))],
